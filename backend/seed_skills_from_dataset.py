"""
Extract skills from AI_Resume_Screening.csv and add new ones to the skill taxonomy.
Checks each skill against the existing database before adding.

Usage: python seed_skills_from_dataset.py
Place AI_Resume_Screening.csv in the backend/data/ folder first.
"""
import pandas as pd
...
CATEGORY_HINTS = {
    ...
    "database": ["mongodb", "mysql", "postgresql", "postgres", "redis", "sqlite", "oracle", "dynamodb", "cassandra", "firebase", "supabase", "elasticsearch", "sql server", "mssql", "mariadb", "neo4j", "couchdb", "influxdb"],
    "cloud": ["aws", "azure", "gcp", "google cloud", "heroku", "vercel", "netlify", "digitalocean", "cloudflare", "lambda", "ec2", "s3"],
    "devops": ["docker", "kubernetes", "jenkins", "terraform", "ansible", "nginx", "linux", "ci/cd", "github actions", "gitlab ci", "puppet", "chef", "vagrant"],
    "tool": ["git", "github", "gitlab", "bitbucket", "jira", "confluence", "postman", "figma", "vscode", "webpack", "vite", "npm", "yarn", "slack"],
    "ml": ["tensorflow", "pytorch", "keras", "scikit-learn", "sklearn", "pandas", "numpy", "matplotlib", "seaborn", "opencv", "spacy", "nltk", "hugging face", "spark", "tableau", "power bi", "jupyter", "xgboost", "lightgbm", "catboost", "mlflow", "airflow", "databricks", "sagemaker", "plotly", "statsmodels", "scipy"],
